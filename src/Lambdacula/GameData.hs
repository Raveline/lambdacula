...
makeExit :: String          -- Main name
            ...
            -> RoomObject   -- An Exit
makeExit name aliases inRoom description room status = Exit (ObjectNames (name:aliases)) inRoom (basicMove room) (RoomObjectDetails status description []) room 
...
ldObjects = [makeExit "south" [] "In front of the castle" "the gate of the castle" "The southern gate" Opened
            ...
            ,makeExit "door" [] "A muddy path" "the gamekeeper shack" "The gamekeeper shack" Opened
